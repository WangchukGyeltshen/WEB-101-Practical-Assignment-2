// src/components/ui/ChatPage.jsx
...
export default function ChatPage() {
  ...
  const { name } = router.query; // Extract the chat participant's name from URL
  ...
  return (
    <div className="p-4 space-y-4">
      <h2 className="text-xl font-bold text-white">{name}'s Chat</h2>
